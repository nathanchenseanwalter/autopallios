"""Week 1 · Images are just numbers — runnable-script twin of 02_images_are_numbers.ipynb.
...
def main() -> None:
    ...
    ax.axis("off")
    plt.savefig(OUTPUT_DIR / "02_images_are_numbers_fig1.png", dpi=150, bbox_inches="tight")
    plt.close()
