"""Week 2 · The PR curve, Average Precision, and ROC AUC — runnable-script twin of 05_pr_curve_and_auc.ipynb.
...
def main() -> None:
    ...
    if det_labels.min() != det_labels.max():  # need both classes for a curve
        ...
        ax.set_xlim(0, 1.02)
        ax.set_ylim(0, 1.02)
        plt.savefig(OUTPUT_DIR / "05_pr_curve_and_auc_fig1.png", dpi=150, bbox_inches="tight")
        plt.close()
