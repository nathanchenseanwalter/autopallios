"""Week 2 · Annotate 5 images — runnable-script twin of 01_annotate_5_images.ipynb.
...
def main() -> None:
    ...
    plt.savefig(OUTPUT_DIR / "01_annotate_5_images_fig1.png", dpi=150, bbox_inches="tight")
    plt.close()
